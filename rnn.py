...
## import packages
##################################################
## the rnn model is adapt from NPNLG exercise sheet 8.1 by Michael Franke and Polina Tsvilodub
import torch
import torch.nn as nn
from a3ds import A3DS_dataset
...
class DecoderRNN(nn.Module):
    def __init__(self, embed_size, hidden_size, vocab_size, visual_embed_size, batch_size=1, num_layers=1):
        ...
        self.lstm = nn.LSTM(self.embed_size + 2 * self.visual_embed_size, self.hidden_size, self.num_layers,
                            batch_first=True)
